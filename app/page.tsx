...
type ProjectSelectionMap = Record<string, Record<string, Record<string, TaskStatus>>>;

// Map: InternalTaskText -> Status
type InternalSelectionMap = Record<string, TaskStatus>;
...
const TASK_GROUPS_TEMPLATE: TaskGroup[] = [
  {
    name: '筹备/商务',
    tasks: [
      '方案制作与路线重制',
...
const generateReport = async (data: ReportGenerationParams): Promise<string> => {
